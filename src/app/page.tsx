        ...
        <div className="space-y-12">
          ...
          <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-md">
            ...
            <ul className="list-disc list-outside ml-5 space-y-2 text-gray-600 dark:text-gray-400">
              <li>Led the development of a TypeScript (Next.js/React) internal platform to enhance operational efficiency in employee management, project oversight, and client relationship tracking.</li>
